...
{
int dest,bd,nt,no;
double hotel_cost , ticket_cost ,expense , discnt;
printf("\n********************************************************************************************************");
...
printf("\n********************************************************************************************************\n");
scanf("%d",&bd);
printf("\n###########\tBOARDING POINT\t:\t");boardpt(bd);
printf("###########");
printf("\nEnter the number of tickets you want to book\n");
scanf("%d",&nt);ticket_cost=ticket(dest);
printf("\nCost of one ticket as per your choice :%d",ticket_cost);ticket_cost*=nt*2;hotel_cost=hotel();
...
printf("\nTotal Cost of all departure as well as return tickets asper your choice :%d",ticket_cost);
...
{
int cost_t[15]
[3]={34200,120000,270200,45500,145700,317700,46500,188450,345800,45500,200000,378000,15000,62000,345700,8300,18000,130000,32500,100000,300000,25000,87000,218000,29330,72900,239700,37250,15700,349000,40000,145500,35900,29500,80700,241250,59450,99900,349600,31800,79000,228500,42000,67300,150000};
printf("\n********************************************************************************************************");
...
scanf("%d",&num);
return cost_t[c][num-1];
}
double hotel()
{
printf("\nChoose a hotel from the choices given below");
printf("\n********************************************************************************************************");
printf("\nHOTEL NAME : COST PER NIGHT : CHOICETO BE ENTERED");
...
if(a==1)
sum=1.25*sum;
printf("\nIf you want to upgrade your room to premium,the cost perday would increase by 30%");
printf("\nEnter 1 to upgrade to premium room or enter 2 to proceedwith the basic room\n");
int b;
scanf("%d",&b);
if(b==1)
sum*=1.30;
...
printf("\nTo upgrade to delux platter ,enter 1 or to continue withbasic platter,enter 2\n");
scanf("%d",&n);
if(n==1)
tot=1.23*tot;
printf("\nIn order to make your stay more pleasurable,all our hotels provide facilities of: ");
printf("\nbeauty salon , gymnasium , spa , ayurvedic treatment andamphitheatre");
printf("********************************************");
...
if(t<=50000)
{
printf("\nCongratulations!!You get an additional discount of5%");
discount=0.05*t;
}
